@REM ft launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM FT_config.txt found in the FT_HOME.
...
set "CFG_FILE=%APP_HOME%\FT_config.txt"
set CFG_OPTS=
...
set "APP_MAIN_CLASS=client.Http2FrameClient"
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running ft.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !FT_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
